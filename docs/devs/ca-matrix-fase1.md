...
**Última execució UAT:** 2026-07-14  
...
| pytest (API + tools + prompts) | 34/34 |
...
| **CA-07** | Mantenir context conversacional | **OK** | [`scripts/uat_context_battery_results.txt`](../../scripts/uat_context_battery_results.txt) — 5/5 PASS | `python scripts/uat_context_battery.py` | Berguedà→dormir allà; reset sessió; idioma ES (#24) |
...
python -m pytest tests/api/ tests/unit/test_tools_registry.py tests/unit/test_prompts.py -q
```
