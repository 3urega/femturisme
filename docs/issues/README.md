...
**Batch RAG:** [plan-fase5-rag-base.md](../devs/plan-fase5-rag-base.md) → [manifest.fase5-rag.json](manifest.fase5-rag.json) — **en curs** ([#27](https://github.com/3urega/femturisme/issues/27)–[#29](https://github.com/3urega/femturisme/issues/29) tancats, [#31](https://github.com/3urega/femturisme/issues/31)–[#33](https://github.com/3urega/femturisme/issues/33) obertes, 2026-07-20).
