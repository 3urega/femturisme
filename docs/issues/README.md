...
**Batch recall catàleg:** [plan-catalog-recall.md](../devs/plan-catalog-recall.md) → [manifest.catalog-recall.json](manifest.catalog-recall.json) — **en curs** ([#36](https://github.com/3urega/femturisme/issues/36)–[#37](https://github.com/3urega/femturisme/issues/37) tancats, [#38](https://github.com/3urega/femturisme/issues/38)–[#40](https://github.com/3urega/femturisme/issues/40) obertes).
