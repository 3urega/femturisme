...
**Batch allotjament proximitat:** [plan-establishments-proximity.md](../devs/plan-establishments-proximity.md) → [manifest.establishments-proximity.json](manifest.establishments-proximity.json) — **en curs** ([#45](https://github.com/3urega/femturisme/issues/45)–[#46](https://github.com/3urega/femturisme/issues/46) tancats; [#47](https://github.com/3urega/femturisme/issues/47)–[#49](https://github.com/3urega/femturisme/issues/49) obertes, 2026-07-21).
