...
| **Implementant codi Python (qualsevol)** | [docs/arquitectura/index.md](docs/arquitectura/index.md) → [capas-y-modulos.md](docs/arquitectura/capas-y-modulos.md) → [patrones-y-convenciones.md](docs/arquitectura/patrones-y-convenciones.md) → [docs/devs/desenvolupament-local.md](docs/devs/desenvolupament-local.md) → [docs/devs/testing.md](docs/devs/testing.md) |
...
| **Dev local (Windows, sense Docker)** | [docs/devs/desenvolupament-local.md](docs/devs/desenvolupament-local.md) |
